...
def preprocess(df, train=True, training_columns=[]):
    ...
    manual_encoding = ["Dual_Sim", "4G", "5G", "Vo5G", "NFC", "IR_Blaster", "memory_card_support"]
    ...
    one_hot_key = ["Processor_Brand", "Notch_Type", "os_name", "brand"]
    ...
    # Standard Scaling
    numberical_columns += ["memory_card_size", "os_version_major", "os_version_minor", "os_version_patch"]
    ...
    unrelated_features = ["rating", "Processor_Series"]
...
if __name__ == "__main__":
    ...
    df.to_csv(r"C:\Users\RexoL\source\repos\Smart-Phone-Prices-Prediction\preproccessed_data.csv", index=False)
